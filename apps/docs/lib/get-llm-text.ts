...
const MDX_COMPONENT_REPLACEMENTS: Record<string, string> = {
	...
	AIToolingCards: `AI tooling: ${DOCS_URL}/llms.txt (docs index for LLMs), ${DOCS_URL}/llms-full.txt (this file), ${DOCS_URL}/guides/mcp (MCP server), ${DOCS_URL}/guides/agent-skills (agent skills), and https://betarouter.com/templates (templates and agents).`,
...
export async function getLLMText(page: InferPageType<typeof source>) {
	...
	// serves this text (betarouter.com proxies /llms-full.txt), so make them
	// absolute docs URLs.
