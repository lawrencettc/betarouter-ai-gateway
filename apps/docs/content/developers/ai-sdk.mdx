...
description: Generate text, stream responses, and call tools with the Vercel AI SDK and betarouter
icon: Zap
---

import { Callout } from "fumadocs-ui/components/callout";

betarouter ships a first-party provider for the [Vercel AI SDK](https://ai-sdk.dev): [`@llmgateway/ai-sdk-provider`](https://github.com/theopenco/llmgateway-ai-sdk-provider). One provider instance and one API key reach every model in the catalog.
...
Set your API key (create one from the [dashboard](https://betarouter.com/dashboard)):
...
See the [routing documentation](/features/routing) for details and the [models page](https://betarouter.com/models) for the full catalog.
