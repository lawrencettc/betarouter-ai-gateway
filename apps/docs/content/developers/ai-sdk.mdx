...
betarouter supports the [Vercel AI SDK](https://ai-sdk.dev) through the [`@llmgateway/ai-sdk-provider`](https://www.npmjs.com/package/@llmgateway/ai-sdk-provider) package. One provider instance and one API key reach every model in the catalog.
