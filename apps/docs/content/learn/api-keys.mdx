---
title: API Keys
description: Create, limit, and control API keys for authenticating with betarouter
icon: Key
---
...
your apps use to authenticate with betarouter.
...
Usage includes both betarouter credits and requests routed through your own
...
rules](/features/api-keys#member-level-iam-rules) on the [Team
page](/learn/team). Those act as a ceiling for every key the member creates:
