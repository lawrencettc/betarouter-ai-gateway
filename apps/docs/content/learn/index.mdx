---
title: Introduction
description: Learn how to navigate and use the betarouter dashboard
icon: BookOpen
---

The betarouter dashboard gives you full control over your LLM API usage, costs, and configuration. This section walks you through every page in the platform, grouped by product.
...
- [**Reset Passes**](/learn/reset-passes) — Instantly restore the BetaPass weekly premium allowance

## Playground

The members' lounge for AI — chat, media studios, and memberships:

- [**Playground Chat**](/learn/playground) — Chat with 200+ models in one interface
...
- [**Playground Memberships**](/learn/chat-plans) — Monthly membership plans for the Playground chat app
