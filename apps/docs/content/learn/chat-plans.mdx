---
title: Chat Plans
description: Monthly subscription plans for the betarouter chat playground
icon: Sparkles
---
...
Playground memberships (formerly Chat Plans) are optional monthly subscriptions for [Playground](https://chat.betarouter.com), the betarouter chat app. Instead of paying per request from your pay-as-you-go balance, a membership gives you a pool of monthly credits worth more than you pay — so heavy chat usage costs less.

<ThemedImage
	alt="Playground membership pricing with Starter, Plus, and Pro tiers"
...
- Open the **Pricing** page from the Playground sidebar to compare tiers and subscribe.
- Your active membership appears in the Playground sidebar with a badge, alongside how many credits remain for the cycle.
