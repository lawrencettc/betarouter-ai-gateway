---
title: Referrals
description: Earn credits by referring other users to betarouter
icon: Users
---

import { ThemedImage } from "@/components/themed-image";

The Referrals page lets you earn credits by inviting others to use betarouter.
...
2. **They Sign Up** — They create an betarouter account using your link
