...
The directory is the same table you know from the public [models page](https://betarouter.com/models), with one row per provider mapping:
...
<Callout type="info">
	...
	[**Enterprise plan**](https://betarouter.com/enterprise). Without one, the
...
<Callout type="info">
	...
	plan**](https://betarouter.com/enterprise). Custom provider keys themselves
	are created on the [Provider Keys](/learn/provider-keys) page.
</Callout>
