...
description: Chat with any LLM interactively in Playground, the betarouter chat app
icon: MessageSquare
---

import { ThemedImage } from "@/components/themed-image";

Playground is a standalone chat app for talking to any LLM through a conversational interface. You can select any supported model, adjust parameters, and see responses in real time.

<ThemedImage alt="Playground chat interface" basePath="/learn/playground" />
