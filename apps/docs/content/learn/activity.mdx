---
title: Activity
description: View and inspect every API request made through betarouter
icon: Activity
---

import { ThemedImage } from "@/components/themed-image";

The Activity page shows a real-time log of every API request routed through betarouter. Use it to debug requests, monitor performance, and track costs per call.
...
How betarouter routed the request:
