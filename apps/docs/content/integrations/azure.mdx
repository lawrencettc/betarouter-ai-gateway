...
description: Connect Azure to betarouter for enterprise-grade OpenAI models
icon: Cloud
---

import { Step, Steps } from "fumadocs-ui/components/steps";

Azure provides access to OpenAI's powerful language models through Microsoft's enterprise cloud infrastructure. This guide shows how to create an Azure resource, deploy models, and integrate them with betarouter.

<Callout type="info">
	Only OpenAI models are supported via Azure at this time. [Contact
	support](mailto:support@betarouter.com) to request support for other model
	types.
</Callout>
...
Azure provides enterprise-grade access to OpenAI models with enhanced security, compliance, and regional availability. betarouter integrates seamlessly with Azure deployments.
...
Once configured, you can access your Azure deployments through betarouter:

- **GPT-4o**: `azure/gpt-4o`
- **GPT-4o Mini**: `azure/gpt-4o-mini`
- **GPT-3.5 Turbo**: `azure/gpt-3.5-turbo` (note: use gpt-3.5-turbo as the betarouter model name instead of gpt-35-turbo)
...
Browse all available models at [betarouter.com/models](https://betarouter.com/models?provider=azure)
