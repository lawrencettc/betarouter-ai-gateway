...
description: Connect AWS Bedrock to betarouter for access to foundation models
icon: Cloud
---

import { Step, Steps } from "fumadocs-ui/components/steps";

AWS Bedrock is Amazon's fully managed service that provides access to foundation models from leading AI companies. This guide shows how to create AWS Bedrock Long-Term API Keys and integrate them with betarouter.
...
Once configured, you can access all AWS Bedrock models through betarouter:
...
Browse all available models at [betarouter.com/models](https://betarouter.com/models?provider=aws-bedrock)
