...
Still want to self-host? betarouter is [open source under AGPLv3](https://betarouter.com/blog/how-to-self-host-llm-gateway)—same features, your infrastructure.

For a detailed breakdown, see [betarouter vs LiteLLM](https://betarouter.com/compare/litellm).
...
Want to see a detailed breakdown of all features? Check out our [betarouter vs LiteLLM comparison page](https://betarouter.com/compare/litellm).
