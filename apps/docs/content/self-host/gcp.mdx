---
title: Google Cloud
description: Deploy betarouter on Google Cloud with GKE, Cloud SQL, Memorystore, and Secret Manager.
icon: Cloud
---
...
This guide covers a production deployment of betarouter on Google Cloud using GKE for the application services and managed Google Cloud services for the backing stores.
...
With the backing services in place, deploy betarouter with the [Helm chart](/self-host/kubernetes), pointing it at your Cloud SQL and Memorystore endpoints:
...
<Callout type="info">
	**Prefer not to wire this up by hand?** The [Enterprise
	...
	secrets — and deploy betarouter in one command. [Talk to
	us](https://betarouter.com/enterprise#contact).
</Callout>
