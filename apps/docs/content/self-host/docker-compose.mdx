...
description: Run betarouter with Docker Compose — each service in its own container for more control.
icon: Layers
---
...
betarouter supports multiple API keys per provider for load balancing and increased availability. Provide comma-separated values:
