...
```bash
curl https://internal.betarouter.com/v1/master/projects \
...
```bash
curl -X POST https://internal.betarouter.com/v1/master/projects \
  -H "Authorization: Bearer $MASTER_KEY" \
...
```bash
curl -X PATCH https://internal.betarouter.com/v1/master/projects/proj_... \
  -H "Authorization: Bearer $MASTER_KEY" \
  -H "Content-Type: application/json" \
  -d '{
...
```bash
curl -X DELETE https://internal.betarouter.com/v1/master/projects/proj_... \
  -H "Authorization: Bearer $MASTER_KEY"
```
...
```bash
curl "https://internal.betarouter.com/v1/master/keys?projectId=proj_..." \
  -H "Authorization: Bearer $MASTER_KEY"
```
...
```bash
curl https://internal.betarouter.com/v1/master/keys/ak_... \
  -H "Authorization: Bearer $MASTER_KEY"
```
...
```bash
curl -X POST https://internal.betarouter.com/v1/master/keys \
  -H "Authorization: Bearer $MASTER_KEY" \
  -H "Content-Type: application/json" \
  -d '{
    "projectId": "proj_...",
...
```bash
curl -X PATCH https://internal.betarouter.com/v1/master/keys/ak_... \
  -H "Authorization: Bearer $MASTER_KEY" \
  -H "Content-Type: application/json" \
  -d '{
    "status": "inactive",
...
```bash
curl -X DELETE https://internal.betarouter.com/v1/master/keys/ak_... \
  -H "Authorization: Bearer $MASTER_KEY"
```
...
```bash
curl https://internal.betarouter.com/v1/master/keys/ak_.../iam \
  -H "Authorization: Bearer $MASTER_KEY"
```
...
```bash
curl -X POST https://internal.betarouter.com/v1/master/keys/ak_.../iam \
  -H "Authorization: Bearer $MASTER_KEY" \
  -H "Content-Type: application/json" \
  -d '{
    "ruleType": "allow_models",
...
```bash
curl -X PATCH https://internal.betarouter.com/v1/master/keys/ak_.../iam/iam_... \
  -H "Authorization: Bearer $MASTER_KEY" \
  -H "Content-Type: application/json" \
  -d '{
    "status": "inactive"
...
```bash
curl -X DELETE https://internal.betarouter.com/v1/master/keys/ak_.../iam/iam_... \
  -H "Authorization: Bearer $MASTER_KEY"
```
...
```bash
curl https://internal.betarouter.com/v1/master/members/jane@example.com/iam \
  -H "Authorization: Bearer $MASTER_KEY"
```
...
```bash
curl -X POST https://internal.betarouter.com/v1/master/members/jane@example.com/iam \
  -H "Authorization: Bearer $MASTER_KEY" \
  -H "Content-Type: application/json" \
  -d '{
    "ruleType": "allow_providers",
...
```bash
curl -X PATCH https://internal.betarouter.com/v1/master/members/uo_.../iam/iam_... \
  -H "Authorization: Bearer $MASTER_KEY" \
  -H "Content-Type: application/json" \
  -d '{
    "status": "inactive"
...
```bash
curl -X DELETE https://internal.betarouter.com/v1/master/members/uo_.../iam/iam_... \
  -H "Authorization: Bearer $MASTER_KEY"
```
...
```bash
curl https://internal.betarouter.com/v1/master/custom-providers \
  -H "Authorization: Bearer $MASTER_KEY"
```
...
```bash
curl -X POST https://internal.betarouter.com/v1/master/custom-providers \
  -H "Authorization: Bearer $MASTER_KEY" \
  -H "Content-Type: application/json" \
  -d '{
    "name": "acme",
...
```bash
curl -X PATCH https://internal.betarouter.com/v1/master/custom-providers/pk_... \
  -H "Authorization: Bearer $MASTER_KEY" \
  -H "Content-Type: application/json" \
  -d '{
...
```bash
curl "https://internal.betarouter.com/v1/master/custom-models?providerKeyId=pk_..." \
  -H "Authorization: Bearer $MASTER_KEY"
```
...
```bash
curl -X POST https://internal.betarouter.com/v1/master/custom-models \
  -H "Authorization: Bearer $MASTER_KEY" \
  -H "Content-Type: application/json" \
  -d '{
    "providerKeyId": "pk_...",
...
```bash
curl -X PATCH https://internal.betarouter.com/v1/master/custom-models/cm_... \
  -H "Authorization: Bearer $MASTER_KEY" \
  -H "Content-Type: application/json" \
