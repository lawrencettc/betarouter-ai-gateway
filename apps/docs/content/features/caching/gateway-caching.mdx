...
description: Serve byte-identical requests entirely from betarouter at $0 cost.
icon: Zap
---
...
1. betarouter generates a cache key based on the request parameters
