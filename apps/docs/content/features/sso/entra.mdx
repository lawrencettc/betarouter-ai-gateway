...
- **Identifier (Entity ID):** `https://internal.betarouter.com/auth/sso/saml2/sp/metadata?providerId=acme-entra`
- **Reply URL (ACS):** `https://internal.betarouter.com/auth/sso/saml2/sp/acs/acme-entra`
...
- **Tenant URL:** the SCIM base URL, e.g. `https://internal.betarouter.com/scim/v2`
