...
Everything your identity provider needs is derived from the **management API base URL** and a **Connection ID** you choose. The base URL defaults to `https://platform-api.betarouter.com`.
...
With `API_URL = https://platform-api.betarouter.com` and a connection slug of `acme-entra`:

| Value                             | URL                                                                                    |
| --------------------------------- | -------------------------------------------------------------------------------------- |
| Identifier (Entity ID) / Audience | `https://platform-api.betarouter.com/auth/sso/saml2/sp/metadata?providerId=acme-entra` |
| Reply URL (ACS)                   | `https://platform-api.betarouter.com/auth/sso/saml2/sp/acs/acme-entra`                 |
| SCIM Tenant URL                   | `https://platform-api.betarouter.com/scim/v2`                                          |
