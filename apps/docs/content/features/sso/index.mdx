...
Everything your identity provider needs is derived from the **management API base URL** and a **Connection ID** you choose. The base URL defaults to `https://internal.betarouter.com`.
