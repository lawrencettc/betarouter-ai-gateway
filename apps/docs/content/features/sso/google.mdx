...
3. betarouter matches the verified email domain and adds them to the organization with the **developer** role.
4. The user receives an email letting them know they've been added.

This applies to **new signups and existing users** alike — an existing betarouter user on your domain joins the organization on their next Google sign-in. Members are never added twice, and members you've already invited are unaffected.
