---
title: Metadata
description: Send additional context and metadata to betarouter using custom headers.
icon: Braces
---

# Metadata

betarouter supports sending additional metadata with your requests using custom headers. This allows you to include information like user sessions, application versions, tenant IDs, or other contextual data that can be useful for analytics and monitoring.
