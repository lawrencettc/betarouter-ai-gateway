...
The `X-Source` header allows you to identify your domain when making requests to betarouter. This information is used to generate public usage statistics showing how betarouter is being used across different websites and applications.
...
Data from the `X-Source` header is used to generate public statistics about betarouter usage, including:

- **Popular Domains**: Which websites and applications are using betarouter most frequently
...
These statistics help demonstrate the adoption and impact of betarouter across the ecosystem.
...
- **Community**: Contributes to the broader betarouter ecosystem
...
- Support transparency in the betarouter ecosystem
