...
description: Generate speech (text-to-speech) using ElevenLabs, Gemini, and OpenAI models through the OpenAI-compatible audio API
icon: Volume2
---
...
betarouter supports text-to-speech (TTS) through the OpenAI-compatible
...
<Callout type="info">
	...
	Studio](https://chat.betarouter.com/audio) in the Playground generates speech
...
[models page](https://betarouter.com/models?filters=1&audioGeneration=true).
...
<Callout type="info">
	...
	See the [models
	page](https://betarouter.com/models?filters=1&audioGeneration=true) for each
...
<Callout type="info">
	Gemini speech models return raw PCM audio. betarouter wraps it in a WAV
...
page](https://betarouter.com/models?filters=1&audioGeneration=true) for rates):
