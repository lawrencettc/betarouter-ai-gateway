...
description: Use betarouter with Cline for AI-powered coding assistance in VS Code
...
[Cline](https://cline.bot) is an autonomous AI coding assistant that lives in your VS Code editor. It can create and edit files, run terminal commands, and help you build complex projects. You can configure Cline to use betarouter for access to multiple AI providers with unified billing and cost tracking.
...
Cline supports OpenAI-compatible API endpoints, making it straightforward to integrate with betarouter.
...
Once configured, you can use all of Cline's features with betarouter:
...
betarouter offers discounted access to some models. Find them on the [models page](https://betarouter.com/models?view=grid&filters=1&discounted=true) and copy the model ID.

### Using Free Models

Some models are available for free. Browse them on the [models page](https://betarouter.com/models?view=grid&filters=1&free=true).
...
## Benefits of Using betarouter with Cline
