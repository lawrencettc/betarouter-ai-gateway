...
![Continue CLI running with betarouter](../../public/guides/continue/2-running.png)
...
Make sure your `apiKey` starts with `beta_` and is valid. Check your [dashboard](https://betarouter.com/dashboard) to confirm the key is active.
