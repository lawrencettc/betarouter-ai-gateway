...
export const COPILOT_CALCULATOR_FAQ: CopilotCalculatorFaqItem[] = [
	...
	},
	{
		...
		answer:
			"It models a chat session as a ~5-turn conversation totaling about 30,000 input and 4,000 output tokens (history is resent every turn), and an agent task as roughly 150,000 input and 8,000 output tokens. Both Copilot AI Credits and betarouter are priced from the same token volumes at the same per-million-token rates, so the comparison isolates the structural differences: seat fees and included credits versus prompt caching and a flat platform fee.",
	},
	{
		question: "Why is the betarouter estimate usually lower?",
		answer:
	...
	},
	{
		...
		answer:
			"Yes. betarouter enforces budgets with hard limits per organization, project, and API key — requests stop at the cap instead of billing past it. Copilot's spending budgets exist in the billing dashboard but are off by default.",
	},
	{
	...
	},
	{
		...
		answer:
			"No. Inline completions weren't moved to usage billing and remain excellent. A common setup keeps Copilot Free or a $10 Pro seat for completions and routes chat and agent workloads through betarouter, where they're cached, capped, and billed at pass-through rates.",
	},
	{
		question: "Is the Copilot cost calculator free to use?",
		answer:
			"Yes — free, no signup, and everything runs in your browser. When you're ready to test real traffic, an betarouter account is free to create and works with any OpenAI-compatible tool.",
	},
];
