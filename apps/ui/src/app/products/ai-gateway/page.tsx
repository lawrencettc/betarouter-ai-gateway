...
export const metadata: Metadata = {
	...
	openGraph: {
		title,
		description,
		url: "https://betarouter.com/products/ai-gateway",
		type: "website",
	},
};
...
const features = [
	...
	},
	{
		...
		description:
			"Restrict which providers and models an organization can reach, pin traffic to approved regions, and record per-provider compliance attestations.",
	},
];
		...
		<>
			...
			<main className="min-h-screen bg-background">
				...
				<div className="mx-auto max-w-6xl space-y-24 px-6 py-20 md:space-y-36 md:py-28">
					...
					<ProductScreenshot
						slug="api-keys"
						alt="betarouter API keys management"
				...
				<ProductClosingCta
					...
					description="Bring your own provider keys for free, or pay as you go with a flat 5% platform fee."
					ctas={[
						{ label: "Get My API Key", href: "/signup" },
