...
export const metadata: Metadata = {
	...
	openGraph: {
		title,
		description,
		url: "https://betarouter.com/products/observability",
		type: "website",
	},
};
		...
		<>
			...
			<main className="min-h-screen bg-background">
				<ProductHero
					...
					description="betarouter records every request that flows through it — usage, spend, latency, errors, and cache performance — and turns it into dashboards your whole team can act on. No agents to install, no separate tracing SDK."
					ctas={[
						{ label: "Open your dashboard", href: "/dashboard" },
						{
							label: "Explore the Knowledge base",
							href: "https://docs.betarouter.com/learn",
							external: true,
							variant: "outline",
						},
					]}
				...
				<div className="mx-auto max-w-6xl space-y-24 px-6 py-20 md:space-y-36 md:py-28">
					<section className="space-y-24 md:space-y-32">
						<ProductScreenshot
							slug="dashboard"
							alt="betarouter analytics dashboard with usage and cost metrics"
						...
						<ProductScreenshot
							slug="activity"
							alt="betarouter activity view with per-request logs"
