...
const DEVPASS_URL = "https://betapass.betarouter.com";

const title = "BetaPass — Flat-Price Dev Plans for AI Coding";
const description =
	"BetaPass turns every dollar into $3 of model usage at provider rates. Fixed-price monthly plans for Claude Code, Cursor, Cline, and any OpenAI-compatible coding tool — 200+ models, one API key.";
...
export const metadata: Metadata = {
	...
	openGraph: {
		title,
		description,
		url: "https://betarouter.com/products/devpass",
		type: "website",
	},
};
...
const features = [
	...
	},
	{
		...
		title: "No lock-in",
		description:
			"Runs on the same betarouter gateway as every other plan. Cancel within 7 days of your first purchase for a refund of your first month, minus metered usage.",
	},
];
			...
			<main className="min-h-screen bg-background">
				...
				<div className="mx-auto max-w-6xl space-y-24 px-6 py-20 md:space-y-36 md:py-28">
					<section className="space-y-24 md:space-y-32">
						<ProductScreenshot
							slug="devpass"
							alt="BetaPass landing page with flat-price dev plans"
						...
						<ProductScreenshot
							...
							alt="BetaPass dashboard showing usage overview and coding agents"
							title="Your coding usage, live"
							description="Track your allowance, per-agent model usage, and activity heatmap from the BetaPass dashboard."
						/>
					</section>

					<ProductFeatureGrid title="Why BetaPass" features={features} />
				</div>
				...
				<ProductClosingCta
					...
					ctas={[{ label: "Get BetaPass", href: DEVPASS_URL, external: true }]}
				/>
			</main>
			<Footer />
		</>
