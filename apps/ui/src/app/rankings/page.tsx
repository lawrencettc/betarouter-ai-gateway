...
const description =
	"Live LLM rankings from real traffic routed through betarouter: top models by token volume, week-over-week trends, and provider market share.";

export const metadata: Metadata = {
	title,
	description,
	alternates: { canonical: "https://betarouter.com/rankings" },
	openGraph: {
		title,
		description,
		type: "website",
		url: "https://betarouter.com/rankings",
	},
	twitter: {
	...
	const breadcrumbSchema = {
		...
		itemListElement: [
			...
			},
			{
				...
				position: 2,
				name: "Rankings",
				item: "https://betarouter.com/rankings",
			},
		],
	};
	...
	const itemListSchema =
		topModels.length > 0
			? {
					"@context": "https://schema.org",
					"@type": "ItemList",
					name: "Top LLMs by usage on betarouter",
					description,
					...
					itemListElement: topModels.map((model, index) => ({
						...
						url: `https://betarouter.com/models/${encodeURIComponent(model.modelId)}`,
					})),
				}
			: null;
				...
				<div className="container mx-auto px-4 py-8">
					<div className="mb-10 max-w-2xl">
						...
						<p className="mt-4 text-muted-foreground md:text-lg">
							...
							token volume routed through betarouter — not benchmarks, not
							vibes.
						</p>
					</div>
					<RankingsContent
