...
const bedrockFaqs: CompareFaqItem[] = [
	...
	},
	{
		...
		answer:
			"Yes. AWS Bedrock is a built-in betarouter provider. Bring your own AWS credentials and route Bedrock traffic through the gateway with 0% markup — you keep your AWS commitments and compliance posture while gaining cross-provider failover, caching, and unified analytics on top.",
	},
	{
		question: "Doesn't Bedrock already have OpenAI and Anthropic models?",
		answer:
			"It does — Bedrock hosts OpenAI's frontier models and Anthropic's Claude family, among others. But the catalog is limited to what AWS hosts: there's no Google Gemini and no fast independent hosts like Groq or Cerebras. betarouter routes across all of them, including Bedrock itself, from one API.",
	},
	{
		question: "How does pricing compare to AWS Bedrock?",
		answer: `Bedrock bills model-provider rates through your AWS account. betarouter charges the same provider rates with a flat 5% platform fee on credits — or 0% when you bring your own provider keys, including AWS credentials. Optional full data retention is billed at ${MARKETING_STATS.dataStoragePrice}.`,
	},
	{
		question: "How hard is it to migrate from Bedrock to betarouter?",
		answer:
			"Minimal effort. betarouter exposes an OpenAI-compatible API, so most apps switch by changing the base URL and API key. There's no IAM policy work, model-access requests, or region planning — sign up, create a key, and every supported model is available immediately.",
	},
];
	...
	return (
		<div className="min-h-screen bg-white text-black dark:bg-black dark:text-white">
			<main>
				...
				<ComparisonBedrock />
				<CompareFaq
					heading="betarouter vs AWS Bedrock"
					description="Common questions about using betarouter alongside or instead of Amazon Bedrock."
					faqs={bedrockFaqs}
				/>
			</main>
			<Footer />
...
export async function generateMetadata() {
	return {
		title: "betarouter vs AWS Bedrock — The Cloud-Neutral Alternative",
		description:
