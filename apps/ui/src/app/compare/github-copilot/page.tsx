...
const copilotFaqs: CompareFaqItem[] = [
	...
	{
		question: "How does betarouter keep AI coding costs predictable?",
		answer:
			...
			<main>
				<HeroCompare
					content={{
						...
						description:
							"Copilot's June 2026 switch to usage-based AI Credits removed the ceiling on your AI bill. betarouter routes any coding agent to 200+ models with zero token markup, prompt caching, and hard budget caps per team, project, and key.",
						badges: [
							"No Token Markup",
							"Hard Budget Caps",
							"200+ Models",
				...
				<CompareFaq
					heading="betarouter vs GitHub Copilot"
...
export async function generateMetadata() {
	return {
		title: "betarouter vs GitHub Copilot — Costs Compared (2026)",
		description:
			"Copilot now bills chat and agents by usage-based AI Credits. Compare it with betarouter: zero token markup, hard budget caps, prompt caching, and 200+ models for any coding agent.",
		alternates: { canonical: "/compare/github-copilot" },
		openGraph: {
			title: "betarouter vs GitHub Copilot — Costs Compared (2026)",
			description:
				"Copilot bills chat and agents by usage-based AI Credits. betarouter: zero token markup, hard budget caps, and 200+ models for any coding agent.",
			type: "website",
			url: "https://betarouter.com/compare/github-copilot",
		},
		twitter: {
