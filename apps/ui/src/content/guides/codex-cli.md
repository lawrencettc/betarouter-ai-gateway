...
On first launch, Codex will prompt you for authentication. Select **Provide your own API key**, then enter your betarouter API key (starts with `beta_`).
...
3. When Codex prompts for authentication, select **Provide your own API key** and enter your betarouter key (starts with `beta_`)
