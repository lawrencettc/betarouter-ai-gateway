...
description: Set up DevPass Code, the open-source terminal coding agent built for betarouter. Install from npm, log in once from your browser, and code with every model on the gateway.
date: 2026-07-03
---
...
| **betarouter DevPass** | The [DevPass](/code) coding subscription — billing is handled automatically |
