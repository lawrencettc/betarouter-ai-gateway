...
{
  "env": {
    "ANTHROPIC_BASE_URL": "https://api.betarouter.com",
...
## Fetching Models From betarouter
...
export ANTHROPIC_CUSTOM_MODEL_OPTION_NAME="GPT-5 via betarouter"
export ANTHROPIC_CUSTOM_MODEL_OPTION_DESCRIPTION="Routed through betarouter"
```
