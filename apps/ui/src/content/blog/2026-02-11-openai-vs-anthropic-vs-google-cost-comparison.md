...
Want to explore pricing for all 200+ models we support? Use our [model comparison tool](/models) to filter by provider, price, context window, and capabilities — then test any model in the [Playground](https://chat.betarouter.com).

**[Browse all models](/models)** | **[Run the Token Cost Calculator](/token-cost-calculator)** | **[Try the Playground](https://chat.betarouter.com)** | **[Get started](/signup)**
