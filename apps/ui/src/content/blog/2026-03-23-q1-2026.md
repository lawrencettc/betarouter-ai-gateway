...
date: 2026-03-23
title: "Q1 2026: Video Gen, Image Studio & Enterprise Features"
summary: "Three months of updates: video generation, Image Studio, sessions, GPT-5.4 family, enterprise guardrails, 5+ new providers, and much more."
...
Here's everything new in betarouter over the first quarter of 2026 — from video generation and image editing to enterprise security features and a wave of new models.

## Video Generation

betarouter now supports **video generation** — submit text prompts and receive generated videos via an async job-based API. Jobs are tracked with status polling and proper error handling for failed generations.
...
The `@llmgateway/ai-sdk-provider` now supports Vercel AI SDK's `generateImage()` via `betarouter.image()`.
...
- **Codex CLI guide** — Using betarouter with OpenAI Codex CLI
