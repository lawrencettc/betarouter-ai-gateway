...
![Audio Studio in the betarouter Playground with multi-track speech generation](/changelog/speech-generation-and-audio-studio.png)
...
[Read the speech docs](https://docs.betarouter.com/features/speech-generation)
...
[Read the embeddings docs](https://docs.betarouter.com/features/embeddings)
...
[Read the OCR docs](https://docs.betarouter.com/features/ocr)

## Video Generation

![ByteDance Seedance video generation models in the betarouter model selector](/changelog/seedance-video-models.png)
...
![Image Studio in the betarouter Playground generating images with GPT Image 2](/screenshots/image-studio-dark.png)
...
[Get your DevPass](https://betarouter.com/code)
...
[Open the Playground](https://chat.betarouter.com)
...
[Read the routing docs](https://docs.betarouter.com/features/routing)

## Enterprise & Security

![Integrated guardrails and custom rules for enterprise safety policies](/changelog/guardrails.png)

- **SOC 2 Type II** — betarouter completed its SOC 2 Type II audit. [Read the announcement](/blog/soc2-type-ii)
...
[Read the payments SDK docs](https://docs.betarouter.com/features/embeddable-payments)
...
![Usage analytics and cost breakdown in the betarouter dashboard](/screenshots/dashboard-dark.png)
...
- **Helm chart** — Self-host betarouter on Kubernetes with a maintained chart. See the [self-hosting guide](/blog/self-host-llm-gateway).
...
**[Explore all models](/models)** | **[Try the Playground](https://chat.betarouter.com)** | **[Get started now](/signup)**
