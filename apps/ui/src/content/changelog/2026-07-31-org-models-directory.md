...
The page reuses the same directory as the public [models page](https://betarouter.com/models) — search, capability filters, price and context ranges, table and grid views. Your custom models appear alongside the catalog, addressed as `{customProvider}/{modelName}`, which is the exact model string to send:
...
**[Org Models Directory docs →](https://docs.betarouter.com/features/models-directory)** | **[Open your dashboard →](https://betarouter.com/dashboard)**
