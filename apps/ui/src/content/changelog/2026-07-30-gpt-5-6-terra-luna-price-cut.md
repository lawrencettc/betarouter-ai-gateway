...
summary: "OpenAI cut GPT-5.6 Terra to $2.00/$12.00 and Luna to $0.20/$1.20 per 1M tokens — Terra is 20% cheaper, Luna 80%. The new rates are live on betarouter and apply automatically to every request, including cached input, cache writes, and long-context pricing."
image:
...
Three weeks after the GPT-5.6 launch, OpenAI [moved the price-performance frontier](https://openai.com/index/advancing-the-price-performance-frontier-with-gpt-5-6/): **GPT-5.6 Terra** is now 20% cheaper and **GPT-5.6 Luna** 80% cheaper. The new rates are already live on betarouter and apply to every request automatically.

## New Rates

| Model                                                          | Input / 1M          | Cached input / 1M   | Output / 1M           |
| -------------------------------------------------------------- | ------------------- | ------------------- | --------------------- |
| [`gpt-5.6-terra`](https://betarouter.com/models/gpt-5.6-terra) | ~~$2.50~~ **$2.00** | ~~$0.25~~ **$0.20** | ~~$15.00~~ **$12.00** |
| [`gpt-5.6-luna`](https://betarouter.com/models/gpt-5.6-luna)   | ~~$1.00~~ **$0.20** | ~~$0.10~~ **$0.02** | ~~$6.00~~ **$1.20**   |
...
**[Browse the models →](https://betarouter.com/models)** | **[OpenAI's announcement →](https://openai.com/index/advancing-the-price-performance-frontier-with-gpt-5-6/)**
