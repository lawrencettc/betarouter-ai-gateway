...
image:
  ...
  alt: "Speech generation and Audio Studio on betarouter"
  width: 1024
  height: 1024
---

betarouter can now talk. Text-to-speech ships today with **nine models across three providers** — all behind the same API key, billing, and logs as your chat, image, and video requests.
...
Supports `voice`, `response_format` (`mp3`, `wav`, `opus`, `aac`, `flac`, `pcm` — varies by family), style `instructions`, and `speed`. See the [speech generation docs](https://docs.betarouter.com/features/speech-generation) for the full reference.
...
They join OpenAI's `tts-1`, `tts-1-hd`, and steerable `gpt-4o-mini-tts`, plus `gemini-2.5-flash-preview-tts` and `gemini-2.5-pro-preview-tts` — **60+ prebuilt voices** in total. Browse them all on the [models page](https://betarouter.com/models?filters=1&audioGeneration=true).
...
**[Try Audio Studio →](https://chat.betarouter.com/audio)**

---

**[Read the announcement →](https://betarouter.com/blog/speech-generation-and-audio-studio)** | **[Speech docs →](https://docs.betarouter.com/features/speech-generation)**
