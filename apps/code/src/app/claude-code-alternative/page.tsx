...
const faqs = [
	...
	},
	{
		...
		answer:
			"Yes. Claude Code accepts a custom endpoint, so switching is two environment variables: set ANTHROPIC_BASE_URL to the BetaPass endpoint and ANTHROPIC_AUTH_TOKEN to your BetaPass key, then run claude as usual. No reinstall, no SDK changes. The /model picker lists the Claude models, and ANTHROPIC_MODEL points the same CLI at any of the other 200+.",
	},
	{
