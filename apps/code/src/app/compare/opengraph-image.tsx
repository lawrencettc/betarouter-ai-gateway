...
export const alt = "BetaPass vs the alternatives — coding plan comparisons";
		...
		>
			<div style={{ display: "flex", alignItems: "center", gap: 14 }}>
				...
				<div style={{ display: "flex", alignItems: "baseline", gap: 10 }}>
					...
					<span style={{ color: "#71717a", fontSize: 20 }}>by betarouter</span>
				</div>
			</div>
			...
			>
				...
				<div style={{ display: "flex", color: "#a1a1aa", fontSize: 30 }}>
					One key to 200+ models — frontier and open-weight — at provider rates.
				</div>
			...
			>
				betapass.betarouter.com/compare
			</div>
		</div>,
		size,
	);
