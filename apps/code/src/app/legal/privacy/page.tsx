...
export default function PrivacyPage() {
	return (
		<>
			...
			<p>
				BetaPass is <strong>metadata only</strong>: we keep the counts, costs,
				...
				retained in your BetaPass logs or dashboard. There is no setting to turn
				payload storage on, on any BetaPass plan — the configurable data
				retention available on pay-as-you-go betarouter organizations does not
				apply to BetaPass.
			</p>
			<p>
			...
			<ul>
				...
				<li>
					...
					BetaPass subscription on every plan (Lite, Pro, and Max)
				</li>
				<li>
