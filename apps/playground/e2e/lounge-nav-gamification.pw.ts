...
// admin. See the sibling pw specs for the same convention.
...
test("signed-in sidebar shows the Playground points pill", async ({
	page,
	baseURL,
}) => {
	test.skip(
...
test("leaderboard page renders the Playground ranking", async ({ page }) => {
