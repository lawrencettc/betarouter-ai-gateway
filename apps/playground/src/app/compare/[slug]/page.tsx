...
export async function generateMetadata({
	...
	return {
		...
		openGraph: {
			...
			description: comparison.metaDescription,
			type: "article",
			url: `https://chat.betarouter.com${canonical}`,
		},
		twitter: {
		...
		itemListElement: [
			{
				...
				position: 1,
				name: "Compare",
				item: "https://chat.betarouter.com/compare",
			},
			{
				"@type": "ListItem",
				position: 2,
				name: `betarouter Chat vs ${comparison.competitor}`,
				item: `https://chat.betarouter.com/compare/${comparison.slug}`,
			},
		],
	};
		...
		<main className="mx-auto max-w-4xl px-4 py-14 sm:py-20">
			...
			<header>
				...
				<h1 className="text-3xl font-bold tracking-tight text-balance sm:text-5xl">
					betarouter Chat vs {comparison.competitor}
				</h1>
			...
			<section className="mt-16">
				<h2 className="mb-5 text-xl font-semibold tracking-tight">
					betarouter Chat vs {comparison.competitor} at a glance
				</h2>
				<ComparisonTable
					competitor={comparison.competitor}
					slug={comparison.slug}
			...
			<section className="mt-16 grid gap-5 sm:grid-cols-2">
				...
				<div className="rounded-2xl border border-foreground/20 bg-card p-6 shadow-sm ring-1 ring-foreground/5">
					<div className="mb-4 flex items-center gap-2.5">
						...
						<h2 className="text-lg font-semibold">Choose betarouter Chat if</h2>
					</div>
					<ul className="space-y-3">
			...
			<section className="mt-16">
				<h2 className="mb-5 text-xl font-semibold tracking-tight">
					betarouter Chat vs {comparison.competitor} FAQ
				</h2>
