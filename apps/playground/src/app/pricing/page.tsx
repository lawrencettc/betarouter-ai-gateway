...
export const metadata: Metadata = {
	...
	description:
		"Every frontier model in one plan — Claude Opus, GPT-5, Gemini and Grok, from $19/mo. Start on fast models from $9/mo. Replaces ChatGPT Plus, Claude Pro and Gemini Advanced — with more usage than you pay for.",
	alternates: {
		canonical: "/pricing",
	},
};
			...
			<section className="mx-auto mt-16 max-w-3xl text-sm text-muted-foreground">
				...
				<ul className="space-y-2">
					...
					<li>
						...
						barely used your plan, email us within 7 days for a full refund.
					</li>
					<li>
						<strong>{"Cancel anytime. "}</strong>Your plan stays active until
