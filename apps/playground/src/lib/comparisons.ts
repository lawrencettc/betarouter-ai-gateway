...
/**
 * betarouter Chat — our own profile. Kept here so the same facts feed every
...
export const comparisons: Comparison[] = [
	{
		...
		metaTitle: "betarouter Chat vs ChatGPT — every model, one subscription",
		metaDescription:
			"ChatGPT only runs OpenAI models. betarouter Chat gives you GPT, Claude, Gemini and Grok on one $19/mo subscription — switch models mid-chat.",
		eyebrow: "Single vendor vs every frontier model",
		verdict:
			"ChatGPT is the most polished single-vendor assistant, and at $20/mo Plus you get GPT plus native image and voice. But you only ever get OpenAI models. betarouter Chat runs GPT, Claude, Gemini, and Grok side by side for $19/mo — so you stop paying separate subscriptions to reach the model that's actually best for the task.",
		usPrice: "$19/mo",
		themPrice: "$20/mo",
		table: [
			{
		...
		sections: [
			{
				...
				bottomLine:
					"Choose ChatGPT if you only ever want GPT. Choose betarouter Chat if you want the best model per task.",
			},
			{
				...
				bottomLine:
					"Comparable entry price, but betarouter Chat spreads it across every provider.",
			},
			{
				...
				bottomLine:
					"ChatGPT's native media is more polished; betarouter Chat covers more providers under one balance.",
			},
		],
		chooseThem: [
		...
		migration:
			"There's nothing to migrate — start a chat at chat.betarouter.com, pick GPT-5 if that's your habit, and add Claude or Gemini to the same thread when you need them. Keep ChatGPT too; many people drop the second subscription once one balance reaches every model.",
		faq: [
			{
				q: "Is betarouter Chat a ChatGPT alternative?",
			...
			{
				q: "Can I still use GPT-5 on betarouter Chat?",
			...
			},
			{
				...
				a: "Both are about $20/mo, but ChatGPT Plus only buys OpenAI models. On betarouter Chat your $19 becomes $47.50 of credits at provider rates that you can spend across every model, with pay-as-you-go top-ups as a fallback.",
			},
			{
				q: "Does it have image generation like ChatGPT?",
				a: "Yes — image, video, and audio generation are built in. ChatGPT's native image generation is more tightly integrated, but betarouter Chat gives you multiple image, video, and audio models on the same balance.",
			},
		],
	},
	{
		...
		category: "single-vendor",
		metaTitle: "betarouter Chat vs Claude — keep Claude, add every other model",
		metaDescription:
			"Claude Pro is $20/mo for Anthropic models only. betarouter Chat keeps Claude and adds GPT, Gemini and Grok on one $19/mo balance — no opaque limits.",
		eyebrow: "One great model vs all of them",
		verdict:
			"Claude is many people's favorite model for writing and code, and Claude Pro at $20/mo is a clean, ad-free experience. The catch is it only runs Anthropic models, it has no native image generation, and its usage limits are famously opaque. betarouter Chat keeps Claude Opus and Sonnet and adds GPT, Gemini, and Grok on one $19/mo balance.",
		usPrice: "$19/mo",
		themPrice: "$20/mo",
		table: [
			{
		...
		sections: [
			{
				...
				bottomLine:
					"Choose Claude if you only ever want Claude. Choose betarouter Chat if you want Claude and everything else.",
			},
			{
			...
			},
			{
				...
				bottomLine:
					"Need to create images, not just read them? That's a clear gap betarouter Chat fills.",
			},
		],
		chooseThem: [
		...
		migration:
			"Keep using Claude exactly as you do — Opus and Sonnet are right here. Start a thread at chat.betarouter.com, pick Claude, and when you hit a wall or want a comparison, switch to GPT or Gemini in the same conversation. Most people keep Claude as their default model and drop the standalone subscription.",
		faq: [
			{
				q: "Does betarouter Chat include Claude?",
			...
			{
				q: "Why use betarouter Chat instead of Claude Pro?",
			...
			},
			{
				...
				a: "Claude Pro and Max enforce an unpublished 'conversation budget' with weekly caps. betarouter Chat uses visible credits — you see each message's cost and your remaining balance, with pay-as-you-go top-ups as a fallback.",
			},
			{
				q: "Can I generate images like I can't on Claude?",
				a: "Yes. Claude can read images but not create them. betarouter Chat includes multiple image, video, and audio generation models in the same subscription.",
			},
		],
	},
	{
		...
		category: "single-vendor",
		metaTitle: "betarouter Chat vs Google Gemini — beyond one model family",
		metaDescription:
			"Google AI Pro is $19.99/mo for Gemini only. betarouter Chat puts Gemini next to GPT, Claude and Grok on one $19/mo subscription with clear credits.",
		eyebrow: "Google's models vs all of them",
		verdict:
			"Gemini is a strong, deeply Google-integrated assistant with a massive context window and native video generation, and Google AI Pro is $19.99/mo. But it only runs Google's models and leans on your Google account to feel valuable. betarouter Chat puts Gemini next to GPT, Claude, and Grok for $19/mo on one balance.",
		usPrice: "$19/mo",
		themPrice: "$19.99/mo",
		table: [
			{
			...
			},
			{
				...
				us: "None — works on its own at chat.betarouter.com",
		...
		sections: [
			{
				...
				bottomLine:
					"Choose Gemini if you're all-in on Google. Choose betarouter Chat if you want Gemini plus everyone else.",
			},
			{
				heading: "Ecosystem and lock-in",
				us: "betarouter Chat is standalone. It doesn't need your email or documents to be useful — you sign in and chat across providers.",
			...
			},
			{
				...
				bottomLine:
					"Gemini bundles more Google perks; betarouter Chat gives clearer, model-agnostic value.",
			},
		],
		chooseThem: [
		...
		migration:
			"Sign in at chat.betarouter.com and pick Gemini — the long-context model you already use is there. Add GPT or Claude to the same thread whenever you want a second take. Nothing is tied to your Google account, so you keep full control of your data.",
		faq: [
			{
				q: "Is betarouter Chat a Google Gemini alternative?",
			...
			},
			{
				...
				a: "Google AI Pro is $19.99/mo for Google's models plus storage and YouTube perks, with value tied to your Google account. betarouter Chat is $19/mo for every frontier model on a standalone, transparent credit balance.",
			},
			{
	...
	},
	{
		...
		category: "aggregator",
		metaTitle: "betarouter Chat vs Poe — multi-model chat without points math",
		metaDescription:
			"Poe meters every model with confusing compute points. betarouter Chat gives you 200+ models on transparent provider-rate credits for $19/mo.",
		eyebrow: "Compute points vs transparent credits",
		verdict:
			"Poe pioneered multi-model chat and has huge breadth, including user-built bots and group chats. Its weak point, by far the most common complaint, is the compute-points system: every model costs a different, hard-to-predict number of points, nothing rolls over, and frontier models drain your balance fast. betarouter Chat is also one balance across every model, but priced as transparent credits at provider rates.",
		usPrice: "$19/mo",
		themPrice: "$19.99/mo",
		table: [
			{
		...
		sections: [
			...
			},
			{
				...
				bottomLine:
					"Both are one balance for many models; betarouter Chat's balance is predictable and has a fallback.",
			},
			{
		...
		migration:
			"Bring the same habit — one balance, every model — minus the points math. Sign in at chat.betarouter.com, and instead of translating messages into points, you spend credits priced at provider rates with each message's cost shown plainly.",
		faq: [
			{
				q: "How is betarouter Chat different from Poe?",
				a: "Both give you many models on one balance. The difference is the meter: Poe uses compute points that vary per model and don't roll over, while betarouter Chat uses credits priced at real provider rates, shown per message, with pay-as-you-go top-ups as a fallback.",
			},
			{
	...
	},
	{
		...
		category: "aggregator",
		metaTitle:
			"betarouter Chat vs T3 Chat — multi-model chat with a media studio",
		metaDescription:
			"T3 Chat is fast $8/mo multi-model chat with no media generation. betarouter Chat adds image, video, audio and group chat across 200+ models.",
		eyebrow: "Fast and minimal vs full studio",
		verdict:
			"T3 Chat is genuinely excellent at one thing: fast, clean multi-model chat for $8/mo, with bring-your-own-key support. It's also deliberately minimal — no native mobile app, no voice, no persistent memory, and no real media generation. betarouter Chat costs more but adds image, video, and audio generation, group chat, and a transparent credit balance.",
		usPrice: "$19/mo",
		themPrice: "$8/mo",
		table: [
			{
		...
		sections: [
			...
			},
			{
				...
				bottomLine:
					"If you want a media studio and model comparison, not just chat, that's the gap betarouter Chat fills.",
			},
			{
				heading: "How you pay",
				...
				bottomLine:
					"T3 is cheaper and BYOK-friendly; betarouter Chat trades a higher price for more capability and clearer value.",
			},
		],
		chooseThem: [
		...
		migration:
			"If you like fast multi-model chat, you'll feel at home — pick a model, start typing at chat.betarouter.com. The difference is what surrounds the chat: image, video, and audio generation, group chat, persistent and shareable conversations, all on one credit balance.",
		faq: [
			{
				q: "Is betarouter Chat worth more than T3 Chat's $8?",
				a: "It depends on what you need. T3 is cheaper and faster for pure text chat. betarouter Chat costs $19 on Plus but adds image, video, and audio generation, side-by-side group chat, persistent shareable conversations, and 200+ models with transparent credits.",
			},
			{
				q: "Does it support bring-your-own-key like T3?",
				a: "betarouter Chat is built around a managed credit balance rather than BYOK. The whole platform, betarouter, does support your own provider keys if you need that route.",
			},
			{
				q: "Is it as fast as T3 Chat?",
				a: "Responses stream in real time and model switching is instant. T3's UI is purpose-built for raw rendering speed, so it still feels fastest for plain text — betarouter Chat trades a little of that for a full media studio.",
			},
			{
	...
	},
	{
		...
		metaTitle: "betarouter Chat vs Perplexity — a chat app, not a search box",
		metaDescription:
			"Perplexity is the best answer engine but weak at open-ended chat and coding. betarouter Chat is a full multi-model chat and media studio for $19/mo.",
		eyebrow: "Cited search vs full multi-model chat",
		verdict:
			"Perplexity is the best tool for cited web research — fast, sourced answers to factual questions. But by design it's an answer engine, not a chat partner: it's weaker at open-ended conversation, creative writing, and sustained coding, and it loses the thread in long sessions. betarouter Chat is a general multi-model chat and media studio. They solve different problems.",
		usPrice: "$19/mo",
		themPrice: "$20/mo",
		table: [
			{
		...
		sections: [
			{
				...
				us: "betarouter Chat is a conversation and creation tool: long threads, drafting, coding, brainstorming, and generating images, video, and audio — with full frontier models you switch between.",
				...
				bottomLine:
					"For 'find and cite an answer,' use Perplexity. For 'think, write, build, create,' use betarouter Chat.",
			},
			{
		...
		migration:
			"Many people keep Perplexity for cited research and use betarouter Chat for everything else — writing, coding, brainstorming, and media. Sign in at chat.betarouter.com, pick any frontier model, and you've got a conversation tool Perplexity was never built to be.",
		faq: [
			{
				q: "Is betarouter Chat a Perplexity alternative?",
				a: "For general chat, creative work, and coding, yes. Perplexity is purpose-built for cited web search; betarouter Chat is a general multi-model chat and media studio. They're often used together.",
			},
			{
			...
			},
			{
				...
				a: "betarouter Chat. It runs full frontier models like GPT, Claude, and Gemini that hold context across long threads, where Perplexity is tuned for short, sourced answers.",
			},
			{
	...
	},
	{
		...
		category: "developer",
		metaTitle:
			"betarouter Chat vs OpenRouter — a real chat app, not a dev tool",
		metaDescription:
			"OpenRouter is a developer API with a bare chatroom. betarouter Chat is a polished $19/mo subscription with media generation and monthly credits.",
		eyebrow: "Metered dev tool vs consumer subscription",
		verdict:
			"OpenRouter is the developer's model marketplace — 400+ models behind one API, zero markup on inference, pay-as-you-go credits. Its chatroom exists, but it's a bare playground with local-only history and no consumer subscription. betarouter Chat is the opposite end: a polished chat app with a real monthly subscription, media generation, and credits at 2.5× value.",
		usPrice: "$19/mo",
		...
		sections: [
			{
				...
				us: "betarouter Chat is a consumer product: you subscribe, you chat, your conversations persist and sync, and you get image, video, and audio generation in the same place.",
			...
			},
			{
				...
				bottomLine:
					"For sheer model count and API economics, OpenRouter leads; for the chat experience, betarouter Chat does.",
			},
		],
		chooseThem: [
		...
		migration:
			"If you've been using OpenRouter's chatroom because you wanted every model in one place, betarouter Chat gives you that as an actual product — persistent, syncing conversations, media generation, and a subscription with monthly credit value. OpenRouter stays the better choice when you're building on the API.",
		faq: [
			{
				q: "Is betarouter Chat like OpenRouter?",
				a: "They share the 'every model on one balance' idea, but OpenRouter is a developer API marketplace whose chatroom is a secondary playground. betarouter Chat is a consumer chat app with a subscription, persistent syncing conversations, and built-in media generation.",
			},
			{
				q: "Does it have more models than OpenRouter?",
				a: "OpenRouter lists more raw models — 400+ versus 200+ — and has zero inference markup for API developers. For chatting, betarouter Chat focuses on a polished experience across every major provider.",
			},
			{
			...
			},
			{
				...
				a: "On OpenRouter the chatroom stores history locally in your browser. betarouter Chat persists and syncs conversations across devices, and lets you share read-only links.",
			},
		],
	},
];
