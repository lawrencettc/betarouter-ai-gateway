		...
		<AlertDialog open={open} onOpenChange={setOpen}>
			...
			<AlertDialogContent className="max-h-[85vh] overflow-y-auto">
				<AlertDialogHeader>
					<AlertDialogTitle>
						{isPlanPayment(transaction.type)
							? "Refund and cancel your plan?"
							: "Refund this payment?"}
					</AlertDialogTitle>
					<AlertDialogDescription>
						{isPlanPayment(transaction.type)
							? `Refunding cancels your chat plan completely: ${formatAmount(transaction.amount, transaction.currency)} goes back to your payment method and your access ends right away — not at the end of the billing period — so the rest of this cycle's credits are lost. To keep using the chat plan you would have to subscribe again. This cannot be undone.`
				...
				<AlertDialogFooter>
					<AlertDialogCancel disabled={refundMutation.isPending}>
						{isPlanPayment(transaction.type) ? "Keep my plan" : "Never mind"}
					</AlertDialogCancel>
					<AlertDialogAction
