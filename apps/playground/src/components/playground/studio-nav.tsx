...
/**
 * Realtime voice calls need the gateway's `/v1/realtime` WebSocket surface,
 * which is not enabled yet (see docs/plan-upstream-integration-140.md,
 * Stage 5). The UI ships dark: the studio tile and the `/realtime` route are
 * both hidden unless `NEXT_PUBLIC_REALTIME_ENABLED` is explicitly "true".
 */
