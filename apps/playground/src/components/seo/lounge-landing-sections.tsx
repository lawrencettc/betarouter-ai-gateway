...
const FAQ_ITEMS = [
	{
		...
		answer: `Lounge is the members' AI chat by betarouter. One membership covers chat with ${MARKETING_STATS.models} AI models — including GPT, Claude, Gemini, and Grok — plus image, video, and audio generation, side-by-side group chats, and a canvas studio, all from a single credit balance.`,
	},
	{
		question: "Which AI models can I chat with?",
		answer: `Lounge routes to ${MARKETING_STATS.models} models across OpenAI, Anthropic, Google, xAI, DeepSeek, Meta, Mistral, and other providers through betarouter. New frontier models arrive as providers release them, and you can switch models mid-conversation without losing context.`,
	},
	{
	...
	},
	{
		...
		answer:
			"Conversations are private to your account, and a chat is only visible to others if you explicitly create a read-only share link. betarouter does not use your conversations to train models. The betarouter privacy policy covers the full details.",
	},
	{
				...
				<section className="mt-20 grid gap-10 lg:grid-cols-2 lg:gap-16">
					<div>
						...
						<p className="mt-4 leading-relaxed text-muted-foreground">
							...
							{MARKETING_STATS.providers} providers, routed through betarouter.
						...
						<p className="mt-4 text-sm text-muted-foreground">
							<a
								href="https://betarouter.com/models"
								className="underline underline-offset-4 hover:text-foreground"
							>
				...
				<section className="mt-20 max-w-3xl">
					...
					<ul className="mt-6 space-y-3 text-muted-foreground">
						...
						<li className="leading-relaxed">
							...
							betarouter does not use your conversations to train models. Read
							the{" "}
							<a
								href="https://betarouter.com/legal/privacy"
								className="text-foreground underline underline-offset-4"
							>
								privacy policy
							</a>{" "}
