...
const variants: Record<SeoVariant, VariantContent> = {
	chat: {
		...
		intro:
			"Lounge is the members' AI chat by betarouter. Chat with GPT, Claude, Gemini, Grok, DeepSeek, Llama, Mistral, and more from a single interface. Switch models mid-conversation, attach files and images, and stream responses in real time — one credit balance, no per-provider billing setup.",
		bullets: [
