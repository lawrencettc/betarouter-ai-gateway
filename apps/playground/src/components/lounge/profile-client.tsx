		...
		return (
			<main className="mx-auto flex max-w-3xl flex-col items-center px-4 py-24 text-center">
				...
				<p className="mt-2 max-w-md text-sm text-muted-foreground">
					Your Playground profile tracks the points, streaks, and level you earn
					by chatting and creating.
				</p>
				...
				{onLeaderboard ? (
					...
					<>
						<p className="mt-2 text-sm text-muted-foreground">
							...
							Playground leaderboard. Only your name, picture, level, and points
							are shown — never your chats.
						</p>
						{!user.username && (
							<Input
								value={usernameInput}
