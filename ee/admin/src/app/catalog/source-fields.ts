...
export const MAPPING_SOURCE_FIELDS: SourceFieldDescriptor[] = [
	...
	{
		key: "supportedVideoSizes",
		label: "Supported video sizes",
		input: "csv",
		nullable: true,
		overridable: true,
		updatable: true,
	...
	{
		key: "supportedVideoDurationsSeconds",
		label: "Video durations (s)",
		input: "json",
		nullable: true,
		overridable: true,
		updatable: true,
	...
	{
		key: "supportedVideoDurationsSecondsImageToVideo",
		label: "Image-to-video durations (s)",
		input: "json",
		nullable: true,
		overridable: true,
		updatable: true,
	...
	{
		key: "contentFilterPrice",
		label: "Content filter price",
		input: "decimal",
		nullable: true,
		overridable: true,
		updatable: true,
