...
/**
 * Org-supplied compliance posture for a custom provider key. BetaRouter does
...
export const modelProviderMapping = pgTable(
	"model_provider_mapping",
	{
		...
		imageOutputPrice: decimal(),
		inputAudioPrice: decimal(),
		cachedImageInputPrice: decimal(),
		cachedInputAudioPrice: decimal(),
